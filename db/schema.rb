...
ActiveRecord::Schema[7.2].define(version: 2025_06_08_225955) do
  ...
  create_table "age_brackets", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "individual_victims_count", default: 0, null: false
  ...
  create_table "draft_case_details", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "case_import_id", null: false
    ...
    t.index ["age_bracket_id"], name: "index_draft_case_details_on_age_bracket_id"
    t.index ["case_import_id"], name: "index_draft_case_details_on_case_import_id"
    t.index ["country_id"], name: "index_draft_case_details_on_country_id"
  end
  ...
  add_foreign_key "draft_case_details", "age_brackets"
  add_foreign_key "draft_case_details", "case_imports"
  add_foreign_key "draft_case_details", "countries"
