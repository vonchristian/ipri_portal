...
module Spreadsheets
  module Imports
    class Criminalization < ActiveInteraction::Base
      ...
      def execute
        create_criminalization
      end

      private

      def create_criminalization
        Criminalizations::Criminalization.create!(
          ...
          case_filing_status: case_data["Was/were the accusation/s or charge/s against the victim legally or formally filed?"],
          case_filing_details: case_data["If yes, where was the case/s filed? (e.g., regional court, military court, supreme court, etc.)"],
          ...
          state_action_to_address_criminalization: nil,
          state_action_to_address_criminalization_details: nil,
          investigation_on_criminalization: nil,
          investigation_on_criminalization_details: nil,
          impact_to_victim_details: nil,
          impact_to_community_details: nil,
        )
      end
    end
  end
