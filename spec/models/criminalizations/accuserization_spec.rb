...
module Criminalizations
  describe Accuserization, type: :model do
    ...
    describe "validations" do
      it "validate accuser_category_id uniqueness scoped to criminalization_id" do
        criminalization = create(:criminalization)
        accuser_category = create(:criminalization_accuser_category)
        create(:criminalization_accuserization, criminalization: criminalization, accuser_category: accuser_category)
